...
const ASSISTANT_INDEX_URL = 'https://cors.s121.top/https://registry.npmmirror.com/@lobehub/agents-index/v1/files/public';

const PLUGINS_INDEX_URL = 'https://cors.s121.top/https://registry.npmmirror.com/@lobehub/plugins-index/v1/files/public';
